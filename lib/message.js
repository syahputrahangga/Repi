exports.teksbanned = [
   "Kaka telah di banned",
   "Maaf kamu sudah di banned",
   "Yahaha udah kena banned mau akses fitur",
   "Mboh karepmu",
];

exports.tekscmd = [
   "Command tidak ditemukan",
   "Maaf kak command tidak di temukan",
   "Gak ada",
   ...
   "Auah kaka bau",
   "Salah ketik itu kak 😮",
   "Kaka ngetik apasih aku ga ngerti 🥺",
   "Oke kak aku proses yah, proses gundulmu ga ada itu dalam menu 😒",
   "Ngetiknya yang bener dong 😠",
   "Enggak mau 🙁",
   "Enggak ah",
   "Berantem yuk 😤",
   "Berantem yuk maju sini 😠",
   "Aku ga mau jawab 😤",
   "Hmm apa yah ga tau aku 🤤",
   "Ga tau aku kan ikan 😎",
   "😚",
   "Hadehh 😑",
   "Maap kaka yang ganteng aku ga tau 🥺",
   "Maap kaka yang cantik aku ga tau 🥺",
   "Muke lu ke gorengan 🤤",
   "Enggak ketemu kak 🥺",
   ...
   "Waduh apaan tuh kak 🙄",
   "Sedang di proses silakan tunggu 3 jam lagi",
   "Gak ada 🙂",
   "Mana saya tau, sayakan ga tau 🙁",
   "Berhenti jangan mainin aku kak 😥",
...
exports.bagai = [
   ...
   "Hah kamu tanya sama aku trus aku tanya ke siapa dong",
   "Whahahaha ga tau 😑",
];
...
exports.ilhamberkata = [
   ...
   "Yang paling melelahkan dalam hidup adalah menjadi orang yang tidak tulus.",
...
exports.katasore = ["Selamat sore", "selamat sore", "Sore", "sore"];
...
exports.oawalah = [
   ...
   "Ada apa kak ?",
   "Bot aktif kak",
   "Aku bukan bot kak, aku ini hooman",
   "Kumaha atuh kak ?",
   "Kunaon kak ?",
   "oy ?",
   "ya ?",
   "Kenapa panggil aku",
   "Ada apa kak kok panggil aku",
   "Naon siah kehed manggil manggil",
];
...
exports.truthdare = {
   Truth: {
      id: [
         "Benar atau tidak bahwa orang yang kamu sukai berada diantara kita semua saat ini?",
         "Sebutkan kejadian paling memalukan yang pernah kamu alami?",
         "Kamu pernah kesal dan membenci aku bukan?",
         "Kamu berpura-pura datang ke kelas sebelah hanya untuk melihat gebetanmu bukan?",
         "Siapa orang yang paling jago bikin kamu tertawa terbahak-bahak?",
         "Ceritakan kejadian yang membuatmu marah besar kepada kakak?",
         "Siapa mantan terindah yang pernah kamu miliki?",
         "Ayo jujur, kamu pernah ada niat untuk kembali berpacaran dengan mantanmu bukan",
         "Beritahu kita semua nama orang yang pernah menolak pernyataan cintamu dulu",
         "Belajar online tapi banyak tugas PR atau belajar disekolah tapi banyak jam kosong?",
         "Siapa yang paling sesuai dengan tipe idealmu di antara anak kelas?",
         "Kasih tau gosip paling parah tentang anak sekolah yang kamu rahasiakan dari kita semua",
         "Apa yang menyebab phobia yang kamu miliki sampai sekarang apa?",
         "Kapan terakhir kali kamu mengompol di celana",
         "Baju terjelek yang pernah dipakai oleh kakak apa? Yang jujur ya jawabnya",
         "Siapa yang gaya berpakaiannya paling payah diantara kita semua?",
         "Barang termurah yang di pakai dan barang termahal yang pernah kamu pakai",
         "Beritahu sifat buruk dari kita semua yang menurut kamu sangat menyebalkan sekali?",
         "Sebutkan film dan lagu yang pernah membuatmu menangis tersedu-sedu",
         "Jalan-jalan ke puncak tapi besoknya ujian atau sekolah tapi banyak jam kosong",
         "Moment paling romantis yang pernah dilakukan kekasihmu apa?",
         "Moment menjijikan yang pernah kamu lihat dan tidak ingin terjadi lagi adalah",
         "Jika kamu mempunyai kekuatan super, kekuatan apa yang ingin kamu miliki?",
         "Kalau kamu dijodohkan oleh papa dan mama, kamu setuju atau tidak?",
         "Jujur, kamu sangat tidak suka kalau papa dan mama mulai membandingkan mu dengan saudara lainnya?",
         "Kalau biaya operasi plastik murah, kamu ingin memiliki wajah seperti artis mana?",
         "Sebutkan kebohongan terbesar yang pernah kamu lakukan kepada mama dan papa?",
         "Kalau besok adalah hari kiamat, kamu ingin menghabis moment terakhir dihidupmu bersama dengan siapa?",
         "Jika kamu dikasih kesempatan untuk reinkarnasi, kamu ingin menjadi siapa pada kehidupan selanjutnya?",
         "Kamu pernah melakukan sebuah pencurian atau tidak?",
         "Jika kamu diberikan kesempatan untuk bertukar kehidupan, kamu ingin bertukar kehidupan selama sehari dengan siapa?",
         "Pilih pacar ngajak jalan berdua dan temen-temen ngajak main bersama-sama?",
         "Diantara kita semua, siapa yang paling tidak bisa berpose dan bergaya ketika di foto?",
         "Masakan siapa diantara kita yang memiliki rasa yang tidak enak?",
         "Jujur, kamu pernah buntutin pacar kamu buat mergokin dia lagi selingkuh kan?",
         "Kamu pernah kepoin mantannya pacar kamu kan cuma buat bandingin visual kamu sama dia?",
         "Jujur ya, kamu pernah ga kentut di dalam kelas?",
         "Apakah kamu pernah memarahi adikmu dan membuatnya menangis?",
         "Apa hal yang paling menjengkelkan yang pernah dilakukan kakak kepada kamu?",
         "Kenapa kamu suka ngelarang adik buat cek meja belajarmu?",
         "Sebutkan mimpi buruk yang paling mengerikan dan nyaris pernah kamu alami?",
         "Apakah kamu hampir mengalami kecelakaan dulunya?",
         "Jika kamu sedang bersedih, galau dan kesal, kamu akan meredakan hal tersebut dengan melakukan apa?",
         "Ayo jujur, kamu selalu menuliskan rasa suka mu terhadap kakak kelas A di buku harianmu bukan?",
         "Sebutkan nama penggilan dimasa kecil yang kamu miliki?",
         "Kamu takut sama hewan apa saja?",
         "Kapan terakhir kali kamu memeluk mama dan papa?",
         "Moment membahagiakan yang pernah kamu alami dalam hidupmu apa?",
         "Kamu pernah cemburu sama adikmu kan karena kamu merasa orang tuamu lebih sayang dengan adikmu ketimbang dirimu sendiri?",
      ],
      eng: [
         "Is it true or not that the person you like is among all of us right now?",
         "What is the most embarrassing incident youve ever experienced?",
         "Youve been annoyed and hated me, right? ",
         "You pretend to come to the next class just to see your crush right?",
         "Who is the person who is the best at making you laugh out loud? ",
         "Tell me an incident that made you angry with brother? ",
         "Who is the most beautiful ex you have ever had? ",
         "Lets be honest, you never had the intention of dating your ex again",
         "Tell us all the names of people who have rejected your first love statement",
         "Studying online but having a lot of homework assignments or studying at school but lots of free hours? ",
         "Who is the most suitable for your ideal type among the class children?",
         "Tell us the worst gossip about school children that you keep secret from us all",
         "What causes the phobia that you have until now? ",
         "When was the last time you peed your pants",
         "What are the worst clothes youve ever worn? The honest answer is yes",
         "Who is the worst dresser of all of us? ",
         "The cheapest item used and the most expensive item you've ever used",
         "Tell us the bad qualities of all of us that you think are very annoying?",
         "Name the movies and songs that made you cry the most.",
         "Going to the top but the next day is exam or school but many hours are empty",
         " What is the most romantic moment your lover has ever done? ",
         "The nastiest moment you've seen and don't want to happen again is",
         " If you have super powers, what strength would you want to have? ",
         "If you are arranged by father and mother, do you agree or not? ",
         "Honestly, you really dont like it when papa and mama start comparing you with other siblings? ",
         "If the cost of plastic surgery is cheap, which artist would you like to have a face? ",
         "What is the biggest lie youve ever done to mama and papa? ",
         "If tomorrow is the Day of Judgment, who do you want to spend the last moment of your life with? ",
         "If you were given the opportunity to reincarnate, who would you like to be in the next life? ",
         "Have you ever committed a theft or not? ",
         "If you were given the opportunity to swap lives, who would you like to swap lives for a day with?",
         "Choose your boyfriend to invite you to hang out together and your friends to invite you to play together? ",
         "Among all of us, who is the least able to pose and style when in photos?",
         "Who among us has a bad taste? ",
         "Honestly, you have been following your boyfriend to catch him cheating, right? ",
         "Have you ever asked your ex-boyfriend to just make a visual comparison between you and him? ",
         "Honestly, have you never farted in class? ",
         "Have you ever scolded your sister and made her cry? ",
         "Whats the most annoying thing you ve ever done to you? ",
         "Why do you like to prevent your sister from checking your study table? ",
         "What is the most terrible nightmare you have ever had? ",
         "Did you almost have an accident before?",
         "If you are sad, upset and upset, what will you relieve it by doing? ",
         "Let s be honest, you always write down how you like seniors A in your diary right? ",
         "What are the names of childhood calls that you have? ",
         "Are you afraid of any animal? ",
         "When was the last time you hugged mom and dad? ",
         "What are the happy moments that you have experienced in your life? ",
         "You were jealous of your younger siblings, right because you felt that your parents loved your younger siblings more than you did? ",
      ],
   },
   Dare: {
      id: [
         "Nyanyikanlah sebuah lagu yang harus dibawakan dengan penuh penghayatan di depan semua orang saat ini",
         "Ayo chat mantan atau gebetanmu dan ketiklah aku kangen kamu lalu kirim. Mari tunggu apa belasan dan reaksinya",
         "Kamu harus menarikan sebuah lagu India dengan diiringi oleh backsound panci dan baskom yang ditabuhkan",
         "Makan dan telan buah lemon sampai habis tanpa tersisa dan tidak boleh dibuang",
         "Ajaklah orang yang tidak kamu kenal untuk menari bersama",
         "Memakai celana legging secara cepat tanpa menggunakan tangan dan hanya diperbolehkan menggunakan kaki",
         "Panggil orang secara random dan katakanlah kamu tampan atau cantik kepada orang tersebut",
         "Gelitiki teman sebangkumu tanpa mengatakan apa alasan dibalik kau melakuka hal tersebut",
         "Larilah ke tengah lapangan seraya menjerit dan mengatakan bahwa aku rindu pada mantanku",
         "Uploadlah sebuah video pada akun sosial media pribadi dimana kamu menarikan sebuah lagu dengan penuh semangat",
      ...
      eng: [
         "Sing a song that must be sung passionately in front of everyone at this time",
         "Let's chat your ex or crush and type I miss you then send. Let's wait a dozen and their reaction",
         "You have to dance to an Indian song accompanied by the backsound of the pot and basin being played",
         "Eat and swallow the lemon until it runs out without remaining and should not be thrown away",
         "Invite people you don't know to dance together",
         "Wear leggings quickly without using your hands and only allowed to use your feet",
         "Call a random person and say you are handsome or beautiful to that person",
         "Tickle your seatmate without saying what the reason is behind you doing it",
         "Run into the middle of the field screaming and saying that I miss my ex",
         "Upload a video on your personal social media account where you dance a song with gusto",
         "Invite someone you don't know to take a selfie together with you then upload it to snapgram",
         "Get random numbers from your contacts and text them\" I'm pregnant ",
         "Take any drink that is near you then mix it with chilies and drink!",
         'Get a random number from your contact, call him, and say "I love you"',
         'Buy the cheapest food in the canteen (or buy a bottle of aqua) and tell your classmate sobbing "This. is the most expensive food I\'ve ever bought "',
         "Buy a bottle of coca cola and splash the flowers with the coca cola in front of the crowd.",
         "Stand near the refrigerator, close your eyes, choose food randomly inside, even when you eat your eyes must be closed .",
         'Stand in the middle of a basketball court and shout, "I LOVE MY PRINCESS / MY PRINCESS',
         'Pay respect to someone in class, then say" Servant at your service, Your Majesty. ',
         'Walk clapping and singing the song" Happy Birthday "from the classroom to the corridor .',
         'Get on one knee and say" Marry me? " same as the first person who entered the room',
         "Make absurd headdresses from tissue, whatever it is, keep asking poses in front of the camera, keep uploading",
         'Say" YOU\'RE BEAUTIFUL / GANTENG SO AWESOME "to the girl you think is the most beautiful in this class',
         'Tell someone in class, "I was just told I was your twin first, we were separated, then I had plastic surgery. And this is the most serious thing I have ever said.',
         "Throw someone's notebook into the trash, in front of his eyes, saying \"This book's contents no one can understand\"",
         "Pull out your own leg hair 3 times!",
         "Chat between your parents, say that you miss them complete with sad emoticons .",
         "Try searcing google about horrible or ridiculous things like trypophobia, etc.",
         "Sit back and relax in the middle of the basketball court pretending it's a sunbathing beach .",
         "fill mouth full of water and have to hold up to two rounds. If you laugh and spill or drink, then you have to refill and add one more round .",
         'Shake hands with the first person to enter this room and say "Welcome to Who Wants To Be a Millionaire!',
         'Send a text message to your parents" Hi, bro! I just bought the latest issue of Playboy magazine!',
         "Send a text to your parents, \"Ma, Pa, I already know that I am an adopted child of the orphanage. Don't hide this anymore.",
         'Send a text to three random numbers in your contact and write "I just became a Playboy magazine model."',
         ...
         "Break the egg using the head!",
         "Eat food that has been mixed and it must be strange, but make sure that the food is not harmful to long term or short term health .",
         "Dancing Girls' Generation style for boys in front of the class, or dancing Super Junior style for girls .",
         "hoist flagpole without flag .",
         "Digging up your crush, closest friends, the opposite sex you don't know at all and the like.",
         "Replicate the hairstyles of all your friends .",
         "Singing the HAI TAYO song in front of a large crowd while dancing",
         "Sing the Baby Shark song loudly in the classroom.",
         "Send something to the neighbor",
         '"Get an autograph on the fiercest teacher while saying" You are truly the person I admire the most in the world. "',
         'Asking someone (random / random) on the street for money saying "I don\'t have money to take an angkot."',
         "Drink something that has been made / agreed upon, but make sure it's not dangerous, like drinking salted syrup and adding soy sauce.\"",
         "follow ig @ rayyreall",
      ],
   },
};
